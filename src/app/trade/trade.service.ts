...
export const insertTrades = async (userId: string, tradeData: Array<any>) => {
    try {
        ...
        throw { message: error.message ?? tradeEntityErrors.tradeInsertFailed };
    }
};
...
export const updateTrade = async (updateTradeData: Record<any, any>) => {
    try {
        ...
        throw { message: error.message ?? tradeEntityErrors.tradeUpdateFailed };
    }
};
...
export const deleteTrade = async (userId: string, tradeId: Record<any, any>) => {
    try {
        ...
        throw { message: error.message ?? tradeEntityErrors.tradeDeleteFailed };
    }
};
